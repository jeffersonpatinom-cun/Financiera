    ...
    BEGIN TRY
        ...
        SET @sql = N'
            ...
            SELECT
                 ...
                 S.ESTADO_ALUMNO, S.MARCA_ACADEMICA,
...
/* ----------------------------------------------------------------------------
   USO:
     -- Mes actual (deriva col Meta_2026 y patrón '%26%' en 2026):
     EXEC Financiera.USP_Foto_Meta_Comercial_Mensual;

     -- Mes específico:
     EXEC Financiera.USP_Foto_Meta_Comercial_Mensual @AnioMes = '202607';

     -- Año nuevo (crea sola la columna Meta_2027, patrón '%27%' automático):
     EXEC Financiera.USP_Foto_Meta_Comercial_Mensual @AnioMes = '202701';
   ---------------------------------------------------------------------------- */
