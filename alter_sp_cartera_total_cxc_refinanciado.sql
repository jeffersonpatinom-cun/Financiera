...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            --   Si existe Financiera.Cartera_Foto_Ayer_PIN_20260826, la foto se toma de ahí en vez de derivarla
            ...
            -- ──────────────────────────────────────────────────────────────────────────────
            IF OBJECT_ID('Financiera.Cartera_Foto_Ayer_PIN_20260826', 'U') IS NOT NULL
            BEGIN
                SELECT *
                INTO Financiera.Cartera_Foto_Ayer
                FROM Financiera.Cartera_Foto_Ayer_PIN_20260826
                WHERE DOCUMENTO = 'NDB';

                DROP TABLE Financiera.Cartera_Foto_Ayer_PIN_20260826;
            END
            ELSE
            BEGIN
        ...
        FROM (
            ...
            FROM (
                ...
                SELECT CAST(LTRIM(RTRIM(NUM_IDENTIFICACION)) AS VARCHAR(50)) AS id_k,
                       ...
                       CAST(CASE
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(CICLO,'')))) COLLATE Latin1_General_CI_AI LIKE 'ESPECIALIZACION%' THEN 'Especializacion'
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(CICLO,'')))) COLLATE Latin1_General_CI_AI LIKE 'PROFESIONAL%'     THEN 'Profesional'
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(CICLO,'')))) COLLATE Latin1_General_CI_AI LIKE 'TECNOLOGO%'       THEN 'Tecn' + CHAR(243) + 'logo'
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(CICLO,'')))) COLLATE Latin1_General_CI_AI LIKE 'TECNICO%'         THEN 'T' + CHAR(233) + 'cnico Profesional'
                        ELSE CICLO
                   END AS VARCHAR(60)) AS CICLO,
                ...
                SELECT CAST(LTRIM(RTRIM(DOC_ALUM)) AS VARCHAR(50)),
                       ...
                       CAST(CASE
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(NIVEL,'')))) COLLATE Latin1_General_CI_AI LIKE 'ESPECIALIZACION%' THEN 'Especializacion'
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(NIVEL,'')))) COLLATE Latin1_General_CI_AI LIKE 'PROFESIONAL%'     THEN 'Profesional'
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(NIVEL,'')))) COLLATE Latin1_General_CI_AI LIKE 'TECNOLOGO%'       THEN 'Tecn' + CHAR(243) + 'logo'
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(NIVEL,'')))) COLLATE Latin1_General_CI_AI LIKE 'TECNICO%'         THEN 'T' + CHAR(233) + 'cnico Profesional'
                        ELSE NIVEL
                   END AS VARCHAR(60)),
                       ...
                       CASE
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(NIVEL,'')))) COLLATE Latin1_General_CI_AI LIKE 'ESPECIALIZACION%' THEN 1
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(NIVEL,'')))) COLLATE Latin1_General_CI_AI LIKE 'PROFESIONAL%'     THEN 2
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(NIVEL,'')))) COLLATE Latin1_General_CI_AI LIKE 'TECNOLOGO%'       THEN 3
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(NIVEL,'')))) COLLATE Latin1_General_CI_AI LIKE 'TECNICO%'         THEN 4
                        WHEN NULLIF(LTRIM(RTRIM(ISNULL(NIVEL,''))),'') IS NULL                                          THEN 6
                        ELSE 5
                   END,
                       2
                ...
                SELECT CAST(LTRIM(RTRIM(NUM_IDENTIFICACION)) AS VARCHAR(50)),
                       ...
                       CAST(MODALIDAD  AS VARCHAR(100)),
                       CAST(CASE
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(NIVEL_FORMACION,'')))) COLLATE Latin1_General_CI_AI LIKE 'ESPECIALIZACION%' THEN 'Especializacion'
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(NIVEL_FORMACION,'')))) COLLATE Latin1_General_CI_AI LIKE 'PROFESIONAL%'     THEN 'Profesional'
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(NIVEL_FORMACION,'')))) COLLATE Latin1_General_CI_AI LIKE 'TECNOLOGO%'       THEN 'Tecn' + CHAR(243) + 'logo'
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(NIVEL_FORMACION,'')))) COLLATE Latin1_General_CI_AI LIKE 'TECNICO%'         THEN 'T' + CHAR(233) + 'cnico Profesional'
                        ELSE NIVEL_FORMACION
                   END AS VARCHAR(60)),
                       CAST(CASE
                       ...
                       CASE
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(NIVEL_FORMACION,'')))) COLLATE Latin1_General_CI_AI LIKE 'ESPECIALIZACION%' THEN 1
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(NIVEL_FORMACION,'')))) COLLATE Latin1_General_CI_AI LIKE 'PROFESIONAL%'     THEN 2
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(NIVEL_FORMACION,'')))) COLLATE Latin1_General_CI_AI LIKE 'TECNOLOGO%'       THEN 3
                        WHEN UPPER(LTRIM(RTRIM(ISNULL(NIVEL_FORMACION,'')))) COLLATE Latin1_General_CI_AI LIKE 'TECNICO%'         THEN 4
                        WHEN NULLIF(LTRIM(RTRIM(ISNULL(NIVEL_FORMACION,''))),'') IS NULL                                          THEN 6
                        ELSE 5
                   END,
                       3
        ...
        ESTADISTICA_DEDUP AS (
                ...
                FROM (
                        ...
                        FROM (
                                SELECT *,
                                        -- Escalera corregida (2026-08-26). La anterior dejaba
        ...
        ESTADISTICA_ACADEMICA AS (
                SELECT DISTINCT NUM_IDENTIFICACION, COD_PERIODO, NOM_UNIDAD,
                        NULL AS NOM_SECCIONAL, MODALIDAD,
        ...
        SELECT
                ...
                COALESCE(NULLIF(LTRIM(RTRIM(ISNULL(B.ESTADO_ALUMNO,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(Z.ESTADO_ALUMNO,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(E.ESTADO_ALUMNO,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(X.ESTADO_ALUMNO,''))),'')) AS ESTADO_ALUMNO,
                COALESCE(NULLIF(LTRIM(RTRIM(ISNULL(B.NOM_UNIDAD,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(Z.NOM_UNIDAD,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(E.NOM_UNIDAD,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(X.NOM_UNIDAD,''))),'')) AS NOM_UNIDAD,
                COALESCE(NULLIF(LTRIM(RTRIM(ISNULL(B.NOM_SECCIONAL,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(Z.NOM_SECCIONAL,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(E.NOM_SECCIONAL,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(X.NOM_SECCIONAL,''))),'')) AS NOM_SECCIONAL,
                COALESCE(NULLIF(LTRIM(RTRIM(ISNULL(B.MODALIDAD,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(Z.MODALIDAD,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(E.MODALIDAD,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(X.MODALIDAD,''))),'')) AS MODALIDAD,
                COALESCE(NULLIF(LTRIM(RTRIM(ISNULL(B.CICLO,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(Z.CICLO,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(E.CICLO,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(X.CICLO,''))),'')) AS CICLO,
                COALESCE(NULLIF(LTRIM(RTRIM(ISNULL(B.NUEVO,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(Z.NUEVO,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(E.NUEVO,''))),''),
                         NULLIF(LTRIM(RTRIM(ISNULL(X.NUEVO,''))),'')) AS NUEVO,
                ...
                -- CXC REFINANCIADO (decision de Cartera 2026-08-28): el estudiante que
        ...
        -- 2do cruce academico por CEDULA SOLA: solo rellena lo que B/Z/E dejaron vacio.
            ...
            FROM (
                SELECT NUM_IDENTIFICACION, COD_PERIODO, PROMEDIO, SEMESTRE,
                    ROW_NUMBER() OVER (
                        PARTITION BY NUM_IDENTIFICACION, COD_PERIODO
                        ORDER BY
                            -- Escalera corregida (2026-08-26), identica a la del PASO 3.
                            CASE
                                WHEN UPPER(LTRIM(RTRIM(ISNULL(CICLO,'')))) COLLATE Latin1_General_CI_AI LIKE 'ESPECIALIZACION%' THEN 1
                                WHEN UPPER(LTRIM(RTRIM(ISNULL(CICLO,'')))) COLLATE Latin1_General_CI_AI LIKE 'PROFESIONAL%'     THEN 2
                                WHEN UPPER(LTRIM(RTRIM(ISNULL(CICLO,'')))) COLLATE Latin1_General_CI_AI LIKE 'TECNOLOGO%'       THEN 3
        ...
        BEGIN
            ...
            -- (2) HERENCIA GENERICA de columnas desde Cartera_Gestion.
